...
public class navalDefaultArmor extends BaseHullMod{
    ...
    public static final float HULL_BONUS = 0f;
    public static final float ARMOR_BONUS = 0f;

    public static final float MIN_CREW_BONUS = 0f;
    public static final float MAX_CREW_BONUS = 0f;

    public static final float MAX_SPEED_BONUS = 0f;
    ...
    public static final float FUEL_USAGE_BONUS = 0f;
    ...
    public void applyEffectsBeforeShipCreation(ShipAPI.HullSize hullSize, MutableShipStatsAPI stats, String id) {
        ...
        MagicIncompatibleHullmods.removeHullmodWithWarning(stats.getVariant(), "on_noarmor", "on_defaultarmor");
        MagicIncompatibleHullmods.removeHullmodWithWarning(stats.getVariant(), "on_thinarmor", "on_defaultarmor");
        MagicIncompatibleHullmods.removeHullmodWithWarning(stats.getVariant(), "on_thickarmor", "on_defaultarmor");
        MagicIncompatibleHullmods.removeHullmodWithWarning(stats.getVariant(), "on_thickestarmor", "on_defaultarmor");
    }

...
public class navalNoArmor extends BaseHullMod {
    ...
    public static final float MAX_CREW_BONUS = 30f;
    ...
    public static final float ENGINE_HP_BONUS = -40f;
    public static final float WEAPON_HP_BONUS = -45f;
    ...
    public void applyEffectsBeforeShipCreation(ShipAPI.HullSize hullSize, MutableShipStatsAPI stats, String id) {
        ...
        MagicIncompatibleHullmods.removeHullmodWithWarning(stats.getVariant(), "on_thinarmor", "on_noarmor");
        MagicIncompatibleHullmods.removeHullmodWithWarning(stats.getVariant(), "on_defaultarmor", "on_noarmor");
        MagicIncompatibleHullmods.removeHullmodWithWarning(stats.getVariant(), "on_thickarmor", "on_noarmor");
        MagicIncompatibleHullmods.removeHullmodWithWarning(stats.getVariant(), "on_thickestarmor", "on_noarmor");
